...
String format(DateTime date,
  ...
  final num seconds = (elapsed / 1000).round();
  final num minutes = (seconds / 60).round();
  final num hours = (minutes / 60).round();
  final num days = (hours / 24).round();
  final num months = (days / 30).round();
  final num years = (days / 365).round();
